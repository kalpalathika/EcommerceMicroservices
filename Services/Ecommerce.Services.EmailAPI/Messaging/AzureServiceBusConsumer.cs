...
namespace Ecommerce.Services.EmailAPI.Messaging
{
    public class AzureServiceBusConsumer : IAzureServiceBusConsumer
    {
        ...
        public AzureServiceBusConsumer(IConfiguration configuration, EmailService emailService)
        {
            ...
            serviceBusConnectionString = Environment.GetEnvironmentVariable("ServiceBusConnectionString") ?? _configuration.GetValue<string>("ServiceBusConnectionString");
        ...
        private async Task OnEmailCartRequestReceived(ProcessMessageEventArgs args)
        {
            ...
            CartDto objMessage = System.Text.Json.JsonSerializer.Deserialize<CartDto>(body);
            try
            {
