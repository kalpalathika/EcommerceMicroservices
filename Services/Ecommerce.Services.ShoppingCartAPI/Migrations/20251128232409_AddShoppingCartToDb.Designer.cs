...
namespace Ecommerce.Services.ShoppingCartAPI.Migrations
{
    ...
    [Migration("20251128232409_AddShoppingCartToDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecommerce.Services.ShoppingCartAPI.Models.CartDetails", b =>
                {
            ...
            modelBuilder.Entity("Ecommerce.Services.ShoppingCartAPI.Models.CartHeader", b =>
                {
                    b.Property<int>("CartHeaderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ecommerce.Services.ShoppingCartAPI.Models.CartDetails", b =>
                {
                    b.HasOne("Ecommerce.Services.ShoppingCartAPI.Models.CartHeader", "CartHeader")
                        .WithMany()
